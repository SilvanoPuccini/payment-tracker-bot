...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 md:h-16 items-center justify-between border-b border-border bg-background/80 backdrop-blur-lg px-4 md:px-6">
      {/* Mobile: App title, Desktop: Search */}
      <div className="flex items-center gap-4">
        <h1 className="text-lg font-bold text-primary md:hidden">PayTrack</h1>
